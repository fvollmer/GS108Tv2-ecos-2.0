 ...
 *
 * $Id: bcmsrom.c,v 1.1 2009/01/05 07:19:05 cchao Exp $
 */

#include <cyg/hal/typedefs.h>
#include <cyg/hal/bcmdefs.h>
...
#include <cyg/hal/bcmsrom.h>
#include <cyg/hal/bcmsrom_tbl.h>
#ifdef BCMSDIO
#include <cyg/hal/bcmsdh.h>
#include <cyg/hal/sdio.h>
#endif /* BCMSDIO */
#ifdef BCMSPI
#include <cyg/hal/spid.h>
#endif /* BCMSPI */

#include <cyg/hal/bcmnvram.h>
#include <cyg/hal/bcmotp.h>

#if defined(BCMUSBDEV) || defined(BCMSDIO) || defined(BCMSDIODEV)
#include <cyg/hal/sbsdio.h>
#include <cyg/hal/sbhnddma.h>
#include <cyg/hal/sbsdpcmdev.h>
#endif /* BCMUSBDEV || BCMSDIO || BCMSDIODEV */

#ifdef WLTEST
#include <cyg/hal/sbsprom.h>
#endif /* WLTEST */
#include <cyg/hal/proto/ethernet.h>	/* for sprom content groking */
	...
	char **vars, uint *count)
{
	...
	*count = 0;
	...
	case JTAG_BUS:
		...
		return 0;
		/* XXX FIXME hack for compile error */
		return initvars_srom_si(sih, osh, curmap, vars, count);
#endif	/* USB4322 */
