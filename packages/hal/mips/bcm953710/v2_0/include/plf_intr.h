...
#define CYGNUM_HAL_INTERRUPT_80211MAC         1
#define CYGNUM_HAL_INTERRUPT_ETHMAC           2
#define CYGNUM_HAL_INTERRUPT_USB_DEVICE       3
#define CYGNUM_HAL_INTERRUPT_USB_HOST         4
#define CYGNUM_HAL_INTERRUPT_TIMER            5
#define CYGNUM_HAL_INTERRUPT_NONE             6
#define CYGNUM_HAL_INTERRUPT_PCI              7
...
/* pci interrupts */
#define CYGNUM_HAL_INTERRUPT_PCI_INTA          2/*CYGNUM_HAL_INTERRUPT_80211MAC*/
#define CYGNUM_HAL_INTERRUPT_PCI_INTB          3/*CYGNUM_HAL_INTERRUPT_ETHMAC*/
