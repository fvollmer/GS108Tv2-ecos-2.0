...
#include <cyg/hal/plf_cache.h>     // for cacheline alignment
...
malloc( size_t size )
{
    ...
    /*
     * Workaround for write-back mode: always return multiples of 16 bytes.
     */
   size = (size + HAL_DCACHE_LINE_SIZE - 1 ) / HAL_DCACHE_LINE_SIZE
