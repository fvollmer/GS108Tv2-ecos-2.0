 ...
 * $Id: etcgmac.c,v 1.13 2009/07/07 13:23:26 jimhuang Exp $
 */
...
#include <cyg/hal/bcmenetphy.h>
#include <cyg/hal/proto/ethernet.h>
#include <cyg/hal/proto/802.1d.h>
#include <cyg/hal/siutils.h>
#include <cyg/hal/sbhnddma.h>
#include <cyg/hal/hnddma.h>
#include "et_dbg.h"
#include <cyg/hal/hndsoc.h>
#include <cyg/hal/bcmgmacmib.h>
#include <cyg/hal/gmac0_core.h>
#include <cyg/hal/gmac_common.h>
...
chipinreset:
    ...
    com_regs = si_setcoreidx(ch->sih, SI_GMAC_COMMON_IDX);
    ASSERT(regs != NULL);
...
chipphyrd(ch_t *ch, uint phyaddr, uint reg)
{
    ...
    origidx = si_coreidx(ch->sih);
    regs = si_setcoreidx(ch->sih, SI_GMAC_COMMON_IDX);
    ASSERT(regs != NULL);
