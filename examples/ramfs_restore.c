...
#define CYGNUM_FS_RAM_BASE_ADDRESS 0xBC380000
#define CYGNUM_FLASH_SECTOR_NUM    4
#define CYGNUM_FLASH_SECTOR_SIZE   0x10000
...
int main( int argc, char **argv )
{
    ...
    CYG_TEST_PASS_FINISH("ramtest_restore");
}
